...
public class BaseDialog extends AppCompatDialog implements
    ...
    public BaseDialog(Context context) {
        this(context, com.hjq.base.R.style.BaseDialogStyle);
    }
    ...
    public static final class AnimStyle {
        ...
        /** 默认动画效果 */
        static final int DEFAULT = com.hjq.base.R.style.ScaleAnimStyle;

        /** 缩放动画 */
        public static final int SCALE = com.hjq.base.R.style.ScaleAnimStyle;

        /** IOS 动画 */
        public static final int IOS = com.hjq.base.R.style.IOSAnimStyle;

        /** 吐司动画 */
        public static final int TOAST = android.R.style.Animation_Toast;

        /** 顶部弹出动画 */
        public static final int TOP = com.hjq.base.R.style.TopAnimStyle;

        /** 底部弹出动画 */
        public static final int BOTTOM = com.hjq.base.R.style.BottomAnimStyle;

        /** 左边弹出动画 */
        public static final int LEFT = com.hjq.base.R.style.LeftAnimStyle;

        /** 右边弹出动画 */
        public static final int RIGHT = com.hjq.base.R.style.RightAnimStyle;
    }
    ...
    public static class Builder<B extends Builder> {
        ...
        /** 主题 */
        private int mThemeId = com.hjq.base.R.style.BaseDialogStyle;
        /** 动画 */
