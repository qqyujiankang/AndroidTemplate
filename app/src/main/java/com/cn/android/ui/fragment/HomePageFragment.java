...
public class HomePageFragment extends MyLazyFragment<HomeActivity> implements
            ...
            case Constant.selectHome:
                ...
                xbanner.setmAdapter( new XBanner.XBannerAdapter() {
                    ...
                    public void loadBanner(XBanner banner, Object model, View view, int position) {
                        ImageLoader.with( getActivity() ).load( shufflingInfoListBeans.get( position ).getImgUrl() ).into( (ImageView) view );
                    }
                } );
    ...
    public void onItemChildClick(BaseQuickAdapter adapter, View view, int position) {
        if (adapter instanceof MarketingDivisionAdapter) {
            ...
            intent.putExtra( "userid", appUserListBeanList.get( position ).getPid() );
            startActivity( intent );
