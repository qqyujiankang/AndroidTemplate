...
public class selectStoreListByPid implements Parcelable {
    ...
    public static selectStoreListByPid objectFromData(String str) {

        return new Gson().fromJson( str, selectStoreListByPid.class );
    }
    ...
    public selectStoreListByPid() {
    }

    protected selectStoreListByPid(Parcel in) {
    ...
    public static final Parcelable.Creator<selectStoreListByPid> CREATOR = new Parcelable.Creator<selectStoreListByPid>() {
        @Override
        public selectStoreListByPid createFromParcel(Parcel source) {
            return new selectStoreListByPid( source );
        }

        @Override
        public selectStoreListByPid[] newArray(int size) {
            return new selectStoreListByPid[size];
        }
    };
}
